...
export function FAQPage() {
  ...
  const faqs = [
    ...
    {
      category: 'reading',
      question: 'What happens to my reading progress if I switch devices?',
      answer: 'Your reading progress is automatically synced across all your devices. You can start reading on your phone and pick up right where you left off on your tablet or computer.'
    },
    {
      category: 'reading',
      question: 'How long do I have access to purchased chapters?',
      answer: 'Forever! Once you purchase a chapter or book, it remains in your library permanently. You can re-read it as many times as you want, whenever you want.'
    },
    ...
    },
    {
      ...
      answer: 'Chapter prices vary depending on the book and author, typically ranging from $0.99 to $2.99 per chapter. Authors set their own prices to ensure fair compensation for their work.'
    },
    {
      category: 'payments',
    ...
    },
    {
      ...
      answer: 'Currently, we operate on a pay-per-chapter or pay-per-book model. This gives you maximum flexibility - only pay for what you want to read, with no recurring charges or commitments.'
    },
    {
      category: 'payments',
      question: 'Do you offer student discounts?',
      answer: 'We\'re exploring discount programs for students and educational institutions. Sign up for our newsletter to be notified when these programs become available.'
    },
    {
      category: 'payments',
      question: 'Are taxes included in the displayed prices?',
      answer: 'Prices shown include applicable taxes for your location. The final price you see at checkout is exactly what you\'ll pay - no hidden fees or surprise charges.'
    },
    ...
    // Account & Settings
    {
      ...
      answer: 'Click the "Sign Up" button in the top right corner. You\'ll need to provide your name, email address, and create a password. If you\'re under 18, make sure you have parental permission before creating an account.'
    },
    {
      category: 'account',
    ...
    },
    {
      ...
      answer: 'Yes! Go to Settings > Account > Edit Profile. You can change your username once every 30 days to prevent confusion among other community members.'
    },
    {
      category: 'account',
    ...
    },
    {
      ...
      answer: 'Each person should have only one account. Multiple accounts may violate our Terms of Service and could result in suspension of all associated accounts.'
    },
    {
      category: 'account',
      question: 'How do I update my email address?',
      answer: 'Go to Settings > Account > Email Settings. You\'ll need to verify your new email address before the change takes effect. This helps protect your account security.'
    },
    ...
    {
      category: 'privacy',
      question: 'Do you collect data on what I read?',
      answer: 'We collect basic reading data (chapters read, progress, reading time) to improve your experience and provide personalized recommendations. This data is never sold to third parties. You can review our data practices in our Privacy Policy.'
    },
    {
      category: 'privacy',
    ...
    },
    {
      ...
      answer: 'We use cookies to enhance your experience, including essential cookies for login and security, analytics cookies to understand usage, and preference cookies to remember your settings. You can manage cookie preferences in your browser settings.'
    },
    {
      category: 'privacy',
      question: 'How do I request my data?',
      answer: 'You have the right to request a copy of all data we hold about you. Email privacy@taaluma.world with your request, and we\'ll provide your data in a machine-readable format within 30 days.'
    },
    ...
    },
    {
      ...
      answer: 'Taaluma works best on the latest versions of Chrome, Firefox, Safari, and Edge. For the best experience, we recommend keeping your browser up to date.'
    },
    {
      category: 'technical',
      question: 'Is there a mobile app?',
      answer: 'We\'re currently working on native mobile apps for iOS and Android! In the meantime, our website is fully mobile-responsive and works great on phones and tablets.'
    },
    {
      category: 'technical',
      question: 'Can I read offline?',
      answer: 'Offline reading is not currently available, but it\'s on our roadmap! For now, you\'ll need an internet connection to access your library and read chapters.'
    },
    {
      category: 'technical',
      question: 'I found a bug. How do I report it?',
      answer: 'We appreciate bug reports! Email support@taaluma.world with a detailed description of the issue, including what you were doing when it occurred and screenshots if possible.'
    },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-3">Popular Topics</h2>
              <p className="text-lg text-muted-foreground">
                Quick access to commonly asked questions
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Learn how to create an account, browse books, and make your first purchase.
                </p>
                <button
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 rounded-full bg-secondary-accent/10 flex items-center justify-center mb-4">
                  <CreditCard className="w-6 h-6 text-secondary-accent" />
                </div>
                <h3 className="font-semibold text-lg mb-2">Payments & Billing</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  Understand our pricing, payment methods, and refund policies.
                </p>
                <button
              ...
              <div className="bg-white rounded-3xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-semibold text-lg mb-2">Privacy & Safety</h3>
                <p className="text-sm text-muted-foreground mb-4">
