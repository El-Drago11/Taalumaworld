import svgPaths from "./svg-cezl01alr2";
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p16671000} id="Vector" stroke="var(--stroke-0, #6B6B6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1ffada00} id="Vector_2" stroke="var(--stroke-0, #6B6B6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M6.66683 5.66406H5.3335" id="Vector_3" stroke="var(--stroke-0, #6B6B6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10.6668 8.33069H5.3335" id="Vector_4" stroke="var(--stroke-0, #6B6B6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d="M10.6668 10.9974H5.3335" id="Vector_5" stroke="var(--stroke-0, #6B6B6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="basis-0 grow h-[20px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6b6b6b] text-[14px] text-nowrap top-[0.16px] tracking-[-0.1504px]">0 pages</p>
      </div>
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex gap-[4px] h-[20px] items-center relative shrink-0 w-[71.836px]" data-name="Container">
      <Icon1 />
      <Text />
    </div>
  );
...
function Icon2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Icon">
          <path d={svgPaths.p2714ccc0} id="Vector" stroke="var(--stroke-0, #6B6B6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p2e681680} id="Vector_2" stroke="var(--stroke-0, #6B6B6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Text1() {
  return (
    <div className="h-[20px] relative shrink-0 w-[95.906px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6b6b6b] text-[14px] text-nowrap top-[0.16px] tracking-[-0.1504px]">Sarah Johnson</p>
      </div>
    </div>
  );
}
...
function ChapterCard3() {
  return (
    <div className="basis-0 grow h-[20px] min-h-px min-w-px relative shrink-0" data-name="ChapterCard">
...
function Text2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[95.102px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#10b981] text-[16px] text-nowrap top-[-0.84px] tracking-[-0.3125px]">Free to Read</p>
      </div>
    </div>
  );
}
...
function ChapterCard4() {
  return (
    <div className="content-stretch flex h-[31px] items-end justify-between pb-0 pt-px px-0 relative shrink-0 w-full" data-name="ChapterCard">
...
function CardContent() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[6px] h-[181px] items-start left-0 pb-0 pt-[16px] px-[16px] top-[158px] w-[315px]" data-name="CardContent">
      <ChapterCard />
      <ChapterCard1 />
      <ChapterCard2 />
      <Container />
...
function ImageTheDiscovery() {
  return (
    <div className="absolute h-[157.664px] left-0 top-0 w-[315.328px]" data-name="Image (The Discovery)">
...
function ChapterCard5() {
  return (
    <div className="absolute bg-[#f5f5f5] h-[157.664px] left-0 overflow-clip top-0 w-[315.328px]" data-name="ChapterCard">
      <ImageTheDiscovery />
      <Badge2 />
    </div>
  );
...
export default function Card() {
  return (
    <div className="bg-white border border-[#e5e5e5] border-solid overflow-clip relative rounded-[24px] size-full" data-name="Card">
      <CardContent />
      <ChapterCard5 />
    </div>
  );
