import svgPaths from "./svg-2atr6r6xdy";
...
function ChapterCard3() {
  return (
    <div className="h-[40px] overflow-clip relative shrink-0 w-full" data-name="ChapterCard">
      <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#6b6b6b] text-[14px] top-[0.16px] tracking-[-0.1504px] w-[248px]">
        <p className="mb-0">{`Emma finds a mysterious device in `}</p>
        <p>&nbsp;</p>
      </div>
    </div>
  );
